...
//  LOTR Converter
//
//  Created by OakHost Customer on 21/03/2022.
//

import SwiftUI

struct IconGrid: View {
    @State var gridLayout = [GridItem(), GridItem(), GridItem()] //die verschiedenen GridItems geben
        ...
        LazyVGrid(columns: gridLayout) {
            ForEach(0..<5) { i in
                if Currency.allCases[i]==currency {
                    ...
                    CurrencyIcon(currencyImage:                             CurrencyImage.allCases[i].rawValue, currencyText:
